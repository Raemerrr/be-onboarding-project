...
public class LongTextItem extends Item {

	private static final short MAX_NAME_LENGTH = 20;
	private static final short MAX_DESCRIPTION_LENGTH = 30;
	private static final short MAX_CONTENT_LENGTH = 50;

	private String name;
	private String description;
	private String content;

	public LongTextItem(boolean required, String name, String description, String content) {
		super(ItemType.LONG_TEXT, required);
		this.name = name;
	...
	public void validate() {
		var errorMessage = "Long text %s must not be empty and must not exceed %d characters";
